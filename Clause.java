...
public class Clause implements Iterable<Literal> {
    ...
    public Literal chooseLiteral() {
        ...
        System.out.println("first"+literals.first());return literals.first();
    }
    public Literal chooseSecond() {
        ImList<Literal> rem= literals.rest();
        System.out.println("second:"+rem.first());
        return(rem.first());
